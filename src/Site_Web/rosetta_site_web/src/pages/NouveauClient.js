        ...
        <Form>
          <Form.Row>
            <Form.Group as={Col}>
              ...
              <Form.Control type="text" placeholder="Ex : Dupont" />
            </Form.Group>

            <Form.Group as={Col}>
              <Form.Label>Prénom</Form.Label>
              <Form.Control type="text" placeholder="Ex : Jean" />
            </Form.Group>
          </Form.Row>

          <Form.Group controlId="formGridEmail">
            <Form.Label>Email</Form.Label>
            <Form.Control type="email" placeholder="Ex : jean@gmail.com" />
          </Form.Group>
          ...
          <Form.Row>
            <Form.Group as={Col} controlId="number">
              ...
              <Form.Control placeholder="Ex : 0611223344"/>
            </Form.Group>
          </Form.Row>
