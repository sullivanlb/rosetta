...
export default class NouveauDevis extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      tva: 20,
      inputs: {
        idDevis: this.props.location.params.devis[0].idDevis,
  ...
  handleDateEdition = (e) => {
    this.setState((prevState) => ({
      inputs: { ...prevState.inputs, dateEditionDevis: e.target.value },
    }));
  };
  ...
  handleDebutTravaux = (e) => {
    this.setState((prevState) => ({
      inputs: { ...prevState.inputs, dateDebutTravauxDevis: e.target.value },
    }));
  };
  ...
  async handleSubmit(e) {
    ...
    formData.append("dateEdition", this.state.inputs.dateEditionDevis);
    formData.append("dateTravaux", this.state.inputs.dateDebutTravauxDevis);
