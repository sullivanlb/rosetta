<?php
	...
	include("../daoDevisDAO.php");
	include("../objets/Pack.php");
	include("../daoPackDAO.php");
	include("../objets/Composant.php");
	include("../daoComposantDAO.php");
	include("../objets/Scenario.php");
	include("../daoScenarioDAO.php");
	include("../objets/Client.php");
	include("../daoClientDAO.php");
	include("../objets/AppartientCD.php");
	include("../daoAppartientCDDAO.php");
	include("../objets/AppartientDC.php");
	include("../daoAppartientDCDAO.php");
	include("../objets/AppartientDP.php");
	include("../daoAppartientDPDAO.php");
	include("../objets/AppartientPC.php");
	include("../daoAppartientPCDAO.php");
	include("../objets/AppartientSC.php");
	include("../daoAppartientSCDAO.php");
	include("../objets/AppartientSP.php");
	include("../daoAppartientSPDAO.php");
	include("../objets/AppartientSQ.php");
	include("../daoAppartientSQDAO.php");
