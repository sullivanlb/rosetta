...
const FooterPage = () => {
  return (
    <MDBFooter color="black" className="mainFoot font-small pt-4 mt-4"  position="fixed-bottom">
      <MDBContainer fluid className="text-center text-md-left">
        <MDBRow>
          ...
          <MDBCol md="4">
            ...
            ADS prend en charge tous vos travaux de plomberie que ce soit en neuf ou en rénovation. 
          ...
          <MDBCol md="3">
            ...
            <ul>
              <li className="list-unstyled">Adresse : 90 avenue Marne , Vannes, 56000, FR</li>
          ...
          <MDBCol md="2">
            ...
            <ul>
              ...
              <li className="list-unstyled">Électricité générale (entreprises)</li>
              <li className="list-unstyled">Salles de bain (vente, installation)</li>
            </ul>
          </MDBCol>
        </MDBRow>
      </MDBContainer>
      <div className="footer-copyright text-center pb-2 pt-0">
        <MDBContainer fluid>
          &copy; {new Date().getFullYear()} Copyright: <a href="https://hourdierthierry.site-solocal.com/"> ADS.com </a>
        </MDBContainer>
      </div>
    </MDBFooter>
  );
