 ...
 */
 export default class SupprimerComposantPack extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <Fragment>
        ...
        <Modal show={this.state.show} onHide={this.handleClose}>
          ...
          <Modal.Body>
            Attention, le composant/pack selectionné sera supprimé définitivement !
          </Modal.Body>
          <Modal.Footer>
            <Button
              variant="ligth"
