...
public class ControleurEnregistrerModificationComposantPack implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        // TODO : check d'abord si quand on enregistre : on save le composant créé, soit on enregistre le pack
        // si on veut save le pack : il faut connaitre l'idPack du Pack
    }
}
