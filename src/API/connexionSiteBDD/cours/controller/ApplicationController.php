...
class ApplicationController{
    ...
    private function __construct(){
        ...
        $this->routes = [
            ...
            'user_add_form' => ['controller'=>null, 'view'=>'InscriptionView'],
            'user_connect' => ['controller'=>'ConnectUserController', 'view'=>'ConnectUserValidationView'],
            'user_connect_form' => ['controller'=>null, 'view'=>'ConnexionView'],
            'user_disconnect' => ['controller'=>'DisconnectUserController', 'view'=>'DisconnectUserView'],
            'upload_activity_form' => ['controller'=>null, 'view'=>'UploadActivityView'],
            'upload_activity' => ['controller'=>'UploadActivityController', 'view'=>'UploadActivityValidationView'],
